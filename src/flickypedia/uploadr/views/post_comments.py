...
def post_comments(task_id: str) -> ViewResponse:
    ...
    return render_template("post_comments.html", current_step="say_thanks", successful_requests=successful_requests, task=task, api_url=url_for("post_bot_comment_api"))
...
def post_bot_comment_api() -> ViewResponse:
    ...
    comment_id = post_bot_comment(user_name=current_user.name, user_url=current_user.profile_url, photo_id=photo_id, wikimedia_page_title=wikimedia_page_title)
